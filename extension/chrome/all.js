(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.githubImprovement = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
//! moment.js
//! version : 2.18.1
...
var detectUrl_1 = require("./detectUrl");
var url_1 = require("./url");
var user_1 = require("./user");
var templateCreator_1 = require("./templateCreator");
...
var API = function () {
    ...
    API.prototype.getUserReceivedEvents = function (page) {
        return __awaiter(this, void 0, void 0, function () {
            var username;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!detectUrl_1.detectUrl.isHomePage()) return [3 /*break*/, 2];
                        return [4 /*yield*/, user_1.user.username()];
                    case 1:
                        username = _a.sent();
                        $.ajax({
                            dataType: 'json',
                            url: url_1.URL.api + url_1.URL.userReceivedEvents(username) + '?page=' + page,
                            success: function success(result) {
                                var HTMLTemplate = templateCreator_1.templateCreator.userReceivedEvents(result);
                                if (page == 1) {
                                    $(".mt-4").prepend('<div id="dashboard-feed"></div>' + '<button class="new-ajax-pagination">' + '<span>More</span>' + icons_1.icons.loading + '</button>');
                                }
    ...
    API.prototype.askForStar = function () {
        return templateCreator_1.templateCreator.arrowDialog("If you liked the project, please give us an <b>Star</b>", 'top', 'position:absolute !important; top:50px; width:365px; text-align:center;', 'dialog-askForStar');
    };
    return API;
}();
exports.API = API;

},{"./detectUrl":3,"./icons":5,"./templateCreator":6,"./url":7,"./user":8}],3:[function(require,module,exports){
"use strict";
...
detectUrl.isHomePage = function () {
    return document.URL === 'https://github.com/';
};
detectUrl.isOurRepo = function () {
...
var functions = function () {
    ...
    functions.createLink = function (url, title, wrapWith, before, after) {
        if (before === void 0) {
            before = '';
        }
        if (after === void 0) {
    ...
    functions.createImageElement = function (url, attributes) {
...
var templateCreator = function () {
    ...
    templateCreator.userReceivedEvents = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            var currentIndexHTMLEnd = '';
            var currentIndexHTMLStart = '';
            var temp_image = '';
            temp_image = functions_1.functions.createImageElement(currentIndex.actor.avatar_url + 'v=3&s=40');
            currentIndexHTML += functions_1.functions.createLink('https://www.github.com/' + currentIndex.actor.login, currentIndex.actor.login, "span", temp_image);
            currentIndexHTMLEnd += " <time>" + moment(currentIndex.created_at).fromNow() + '</time>';
            if (currentIndex.type === 'WatchEvent') {
                currentIndexHTMLStart += icons_1.icons.star;
                currentIndexHTML += ' starred ';
                currentIndexHTML += functions_1.functions.createLink('https://www.github.com/' + currentIndex.repo.name, currentIndex.repo.name, "span");
            } else if (currentIndex.type === 'ForkEvent') {
                currentIndexHTMLStart += icons_1.icons.fork;
                currentIndexHTML += ' forked ';
                currentIndexHTML += functions_1.functions.createLink('https://www.github.com/' + currentIndex.repo.name, currentIndex.repo.name, "span");
            } else if (currentIndex.type === 'MemberEvent') {
                currentIndexHTMLStart += icons_1.icons.member;
                currentIndexHTML += ' added ';
                temp_image = functions_1.functions.createImageElement(currentIndex.payload.member.avatar_url + '?v=3&s=40');
                currentIndexHTML += functions_1.functions.createLink('https://www.github.com/' + currentIndex.payload.member.login, currentIndex.payload.member.login, 'span', temp_image);
                currentIndexHTML += " to ";
                currentIndexHTML += functions_1.functions.createLink('https://www.github.com/' + currentIndex.repo.name, currentIndex.repo.name, "span");
            } else if (currentIndex.type === 'PublicEvent') {
                currentIndexHTMLStart += icons_1.icons.create;
            ...
            HTMLTemplate += '<div class="received-event-item">' + currentIndexHTMLStart + currentIndexHTML + currentIndexHTMLEnd + '</div>';
        }
        return HTMLTemplate;
    };
    templateCreator.arrowDialog = function (text, position, style, className) {
        ...
        var arrowDialog = '<div class="arrow_box arrow_box--' + position + " " + className + '"';
...
},{"./functions":4,"./icons":5,"moment":1}],7:[function(require,module,exports){
"use strict";
...
},{"./functions":4}],8:[function(require,module,exports){
"use strict";
