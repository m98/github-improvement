...
var API = function () {
    ...
    API.prototype.getUserReceivedEvents = function () {
        return __awaiter(this, void 0, void 0, function () {
            var getUserReceivedEventsFlag, username;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!getUserReceivedEventsFlag) {}
                        if (!detectUrl_1.detectUrl.isGitHub()) return [3 /*break*/, 2];
                        return [4 /*yield*/, user_1.user.username()];
                    case 1:
                        username = _a.sent();
                        $.ajax({
                            dataType: 'json',
                            url: url_1.URL.api + url_1.URL.userReceivedEvents(username),
...
},{"./detectUrl":3,"./templateCreator":6,"./url":7,"./user":8}],3:[function(require,module,exports){
"use strict";
...
var templateCreator = function () {
    ...
    templateCreator.userReceivedEvents = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            currentIndexHTML += functions_1.functions.createLink('https://www.github.com/' + currentIndex.actor.login, currentIndex.repo.name, "span", temp_image);
            ...
            if (currentIndex.type === 'WatchEvent') {
                ...
                HTMLTemplate += functions_1.functions.createLink('https://www.github.com/' + currentIndex.repo.name, currentIndex.repo.name, "span");
            ...
            HTMLTemplate += '<div style="display:block; margin-top:20px; ">' + currentIndexHTMLStart + currentIndexHTML + currentIndexHTMLEnd + '</div>';
        }
        return HTMLTemplate;
    };
